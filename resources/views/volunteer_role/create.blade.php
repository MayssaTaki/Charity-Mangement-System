...
<div Style="background-color:white;border-bottom: 0.9px solid gray;color:gray;">           
         ...
         <h2> <i class="fas fa-plus"> Add  Volunteer Role</i> </h2> 
        </div>
		   </div>
        </div>
...
<form action="{{ route('volunteer_role.store') }}" method="POST">
    {{ csrf_field() }}
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn-primary" event="{{ route('volunteer_role.index')}}">Submit</button>
        </div>
